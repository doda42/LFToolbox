...
% Order is one of 'stuv', 'tvsu', 'sutv', 'uvst', 'svtu', 'tusv'
%
% todo: doc
...
function [Img, x1,y1,XTick,YTick,XLabels,YLabels] = LFDispTiles( LF, Order, BorderSize, BorderColor, FoldingRate, FoldingMethod, varargin )

Order = LFDefaultVal('Order', 'stuv');
...
LF = LFDispResamp( LF, FoldingRate, FoldingMethod );
